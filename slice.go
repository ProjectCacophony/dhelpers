...
// SliceContainsLowerExclude returns true if args contains a string in include, false if not
...
func SliceContainsLowerExclude(args, include []string) (includes bool, newArgs []string) {
